                            ...
                            <tr key={user._id}>
                                    ...
                                    <div className="flex items-center gap-3">
                                        <div className="avatar">
                                            <div className="mask mask-squircle w-12 h-12">
                                                <img src={user.photoURL || "https://i.ibb.co/hYsm3Dq/default-user.png"} alt="Avatar" />
                                            </div>
                                        </div>
                                        <div>
                                ...
                                <td>
                                    {user.role === 'admin' ? <span className="badge badge-primary">Admin</span> : 
                                     user.role === 'tutor' ? <span className="badge badge-secondary">Tutor</span> : 
                                ...
                                <td className="space-x-2">
                                    ...
                                    {user.role !== 'admin' && (
                                        <button 
                                            ...
                                            className="btn btn-xs btn-primary tooltip" data-tip="Make Admin">
                                            <FaUserShield />
                                        </button>
                                    )}
                                    ser.role !== 'tutor' && (
                                        <button 
                                            ...
                                            className="btn btn-xs btn-secondary tooltip" data-tip="Make Tutor">
                                            <FaChalkboardTeacher />
                                        </button>
                                    )}
                                </td>
